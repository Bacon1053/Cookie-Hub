if game:GetService("CoreGui"):FindFirstChild("Cookiee-Hub") then
    game:GetService("CoreGui"):FindFirstChild("Cookiee-Hub"):Destroy()
end
...
local library = {flags = {}, toggled = true, keybind = Enum.KeyCode.V, dragSpeed = 0.1}
...
local Cookiee = utility.create("ScreenGui", {})
Cookiee.Name = "Cookiee-Hub"
Cookiee.Parent = coreGui

inputService.InputBegan:Connect(function(input)
    if input.KeyCode == library.keybind then
        library.toggled = not library.toggled
        Cookiee.Enabled = library.toggled
    end
end)
